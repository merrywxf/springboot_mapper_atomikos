...
/**
 * Created by cdliujian1 on 2016/1/13. 包工具，根据package路径，加载class
 */
public class PackageUtil {
	...
	public static void main(String[] args) {
		String packages = "com.cn.controller.test";
		System.out.println("检测前的package: " + packages);
		Set<String> set = findPackageClass(packages);
		set.forEach(m -> {
			System.out.println(m);
		});
		// System.out.println("检测后的package: " +
		// StringUtils.join(checkPackage(packages), ","));
	}
